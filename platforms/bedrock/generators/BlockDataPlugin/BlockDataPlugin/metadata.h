...
#define PLUGIN_NAME                 "BlockDataPlugin"
#define PLUGIN_INTRODUCTION         "A plugin that exports the binary NBT of the block entity at 100,100,100"
#define PLUGIN_AUTHOR               "gentlegiantJGC"
